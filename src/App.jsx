  ...
  return (
    <>
            ...
            theme: {
              extend: {
                colors: {
                  ...
                  'terracotta': { 400: '#f8b49e', 500: '#E28A6D', 600: '#d46a4d', 700: '#b85133' },
                  'gold': '#FFC72C',
                   gray: { 100: '#f9fafb', 300: '#d1d5db', 400: '#9ca3af', 500: '#6b7280', 600: '#4b5563', 700: '#374151', 800: '#1f2937', 900: '#111827' },
                },
                fontFamily: {
      ...
      <style>{`
        ...
        .io-textarea {
            flex-grow: 1; width: 100%; min-height: 150px; padding: 0.75rem; 
            border-radius: 0.5rem; border: 1px solid #4b5563; background-color: #1f2937; 
            color: #f9fafb; font-size: 1rem; font-family: inherit; resize: vertical;
